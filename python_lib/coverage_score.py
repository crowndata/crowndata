...
def main():
    ...
    traj_a = "public/data/droid_00000000/trajectories/cartesian_position__trajectory.json"
    traj_b = "public/data/droid_00000001/trajectories/cartesian_position__trajectory.json"
